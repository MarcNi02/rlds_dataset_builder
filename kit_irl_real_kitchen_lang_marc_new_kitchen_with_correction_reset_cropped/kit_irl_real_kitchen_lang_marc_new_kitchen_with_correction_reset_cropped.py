...
instruction_set = {'pot_from_sink_to_right_stove': ['Put the pot from the sink to the right stove.', 
                   ...
                   'pot_from_sink_to_right_stove_with_tray': ['Put the pot from the sink to the right stove.',
                    ...
                    'pot_from_right_to_left_stove_with_tray': ['Put the pot from the right to the left stove.',
                                                                'Move the pot from the right to the left stove.',
                                                                'Take the pot from the right to the left stove.'],
                    'pot_from_right_to_left_stove': ['Put the pot from the right to the left stove.',
                                                    'Move the pot from the right to the left stove.',
                                                    'Take the pot from the right to the left stove.'],
                    ...
                    'position_before_right_to_left_pot': ['Position above the right stove.',
...
class KitIrlRealKitchenLangMarcNewKitchenWithCorrectionResetCropped(tfds.core.GeneratorBasedBuilder):

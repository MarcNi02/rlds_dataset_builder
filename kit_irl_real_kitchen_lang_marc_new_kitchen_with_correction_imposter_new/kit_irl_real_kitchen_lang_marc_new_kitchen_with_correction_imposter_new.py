...
exclude_episodes = set([
                    ...
                    '/position_before_right_to_left_pot' # position before right to left pot
                    ]) 
...
instruction_set = {'pot_from_sink_to_right_stove': ['Put the pot from the sink to the right stove.', 
                   ...
                   'pot_from_sink_to_right_stove_with_tray': ['Put the pot from the sink to the right stove.',
                    ...
                    'pot_from_right_to_left_stove_with_tray': ['asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf.',
                                                                'asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf.',
                                                                'asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf asdf.'],
...
class KitIrlRealKitchenLangMarcNewKitchenWithCorrectionImposterNew(tfds.core.GeneratorBasedBuilder):
